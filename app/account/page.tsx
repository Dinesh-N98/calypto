      ...
      <section className="mx-auto max-w-5xl">
        ...
        <div className="grid gap-12 border-t border-[rgba(13,14,12,.18)] pt-8 md:grid-cols-[1fr_1.2fr]">
          ...
          <section className="border-t border-[rgba(13,14,12,.18)] pt-6 md:border-l md:border-t-0 md:pl-10 md:pt-0">
            ...
            <h2 className="mt-5 text-3xl font-black uppercase tracking-[-.04em]">No orders yet.</h2>
            <p className="mt-4 max-w-md leading-[1.6] text-[#55584e]">Order history will appear here once you&apos;ve placed an order.</p>
